...
posterior_fitted <- epred_draws(te_model, value = "fit", scale = "probability", include_newdata = FALSE)
...
posterior_treat_eff <-
  treatment_effects(te_model, treatment = "z", scale = "probability", newdata = dat)
...
posterior_ate <- tidy_ate(te_model, treatment = "z", scale = "probability", newdata = dat)
posterior_att <- tidy_att(te_model, treatment = "z", scale = "probability", newdata = dat)
...
# NOTE: common support explicitly calculated on linear scale (not probability scale for probit/logit)
# by specifying scale = "linear"
...
posterior_treat_eff_on_treated <-
  treatment_effects(te_model, treatment = "z", subset = "treated", newdata = dat,
                    common_support_method = "sd", scale = "linear")
