...
**NOTE: Vignette from here it is not working or not tested**
...
```
```{r cates-hist, echo=TRUE, cache=FALSE, eval = F}
...
```{r ate-trace-setup, eval = TRUE, echo = FALSE, eval = F}
...
```{r ate-trace, eval=TRUE, echo=TRUE, eval = F}
...
```{r cates-hist-treated, echo=TRUE, cache=FALSE, eval = F}
...
```{r cates-stack-plot, echo=TRUE, cache=FALSE, eval = F}
...
```{r cates-line-plot, echo=TRUE, cache=FALSE, eval = F}
...
```{r common-support, echo=TRUE, results='hide', cache=FALSE, eval = F}
...
```{r interaction-investigator, echo=TRUE, cache=FALSE, eval = F}
...
```{r sigma-trace, echo=TRUE, cache=FALSE, eval = F}
...
```{r convergence-bart, echo=TRUE, cache=FALSE, eval = F}
