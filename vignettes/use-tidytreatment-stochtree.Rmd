...
vs_bart <- bart(X_train = dat_covariates, y_train = dat$y, num_burnin = 5000, num_mcmc = 1000, 
...
prop_score <- epred_draws(ps_bart, rfx_group_ids = dat$subject_id) |> 
...
posterior_fitted <- epred_draws(te_bart, value = "fitted",  include_newdata = FALSE)
