...
```{r plot-tidy-bart, echo=TRUE, cache=TRUE}
...
Posterior conditional (average) treatment effects can be calculated using the ``

```{r cates-hist, echo=TRUE, cache=TRUE}
...
```{r cates-stack-plot, echo=TRUE, cache=TRUE}
...
```{r cates-line-plot, echo=TRUE, cache=TRUE}
