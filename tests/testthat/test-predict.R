...
smpl_id <- c(30L, 81L, 97L, 44L, 52L, 43L, 34L, 89L, 88L, 87L, 93L, 14L,
...
test_that("Predicted values calculated correctly", {
  td_pd <- predicted_draws(bartmodel1, newdata = pdata, include_newdata = FALSE, prediction = "pred",
                           rng = function(n, mean, ...){ mean + 0.1}) # random noise fixed
